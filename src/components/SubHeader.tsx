...
export default function SubHeader({ title, userRole, tenantName }: SubHeaderProps) {
  ...
  const managementLinks = [
    {
      ...
      label: 'NCTS Abgang',
      icon: 'M369.9 97.9L286 14C277 5 264.8-.1 252.1-.1H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V131.9c0-12.7-5.1-25-14.1-34zM332.1 128H256V51.9l76.1 76.1zM48 464V48h160v104c0 13.3 10.7 24 24 24h104v288H48z',
    },
    {
      path: '/dashboard/companies',
      label: 'Firmen',
      icon: 'M320 336c0 8.84-7.16 16-16 16h-96c-8.84 0-16-7.16-16-16v-48H0v144c0 25.6 22.4 48 48 48h416c25.6 0 48-22.4 48-48V288H320v48zm144-208h-80V80c0-25.6-22.4-48-48-48H176c-25.6 0-48 22.4-48 48v48H48c-25.6 0-48 22.4-48 48v80h512v-80c0-25.6-22.4-48-48-48zm-144 0H192V96h128v32z',
    },
    {
      path: '/dashboard/guarantees',
      label: 'Bürgschaften',
      icon: 'M280 240H168c-4.4 0-8 3.6-8 8v16c0 4.4 3.6 8 8 8h112c4.4 0 8-3.6 8-8v-16c0-4.4-3.6-8-8-8zm0 96H168c-4.4 0-8 3.6-8 8v16c0 4.4 3.6 8 8 8h112c4.4 0 8-3.6 8-8v-16c0-4.4-3.6-8-8-8zM496 80V48c0-8.84-7.16-16-16-16H32C23.16 32 16 39.16 16 48v32c0 8.84 7.16 16 16 16h16v336c0 17.67 14.33 32 32 32h128v-64c0-17.67 14.33-32 32-32s32 14.33 32 32v64h128c17.67 0 32-14.33 32-32V96h16c8.84 0 16-7.16 16-16zm-176 0H192V56h128v24z',
    },
    {
    ...
    {
      path: '/dashboard/goods-locations',
      label: 'Warenorte',
  ...
  if (!canAccessAdmin) {
    return (
      ...
      >
        <h2 className="text-gray-800 text-xl font-normal leading-none">{title}</h2>
      </div>
    )
  }
