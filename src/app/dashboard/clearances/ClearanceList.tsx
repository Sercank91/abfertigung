...
export default function ClearanceList() {
  ...
  const filteredClearances = clearances.filter((clearance) => {
    ...
    if (
      filterLicensePlate &&
      !clearance.licensePlate.toLowerCase().includes(filterLicensePlate.toLowerCase())
    ) {
      return false
    }
    ...
    if (
      filterCompany &&
      !clearance.company.name.toLowerCase().includes(filterCompany.toLowerCase())
    ) {
      return false
    }
    ...
    if (filterCreatedBy) {
      const fullName =
        `${clearance.createdBy.firstName} ${clearance.createdBy.lastName}`.toLowerCase()
    ...
    if (filterUpdatedBy && clearance.updatedBy) {
      const fullName =
        `${clearance.updatedBy.firstName} ${clearance.updatedBy.lastName}`.toLowerCase()
    ...
    <>
      ...
      <div className="mb-4 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleRefresh} className="btn btn-outline-secondary" disabled={loading}>
            <svg className="inline-block w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 512 512">
      ...
      <div className="row gx-1 mb-4">
        <div className="col-auto">
          <label htmlFor="filter_datumVon" className="tt-label">
            Datum von
          </label>
          <input
            type="date"
        ...
        <div className="col-auto">
          <label htmlFor="filter_datumBis" className="tt-label">
            Datum bis
          </label>
          <input
            type="date"
        ...
        {/* ✅ NEU: AnmNr Filter */}
        <div className="col">
          <label htmlFor="filter_anmnr" className="tt-label">
            Anmelde Nummer
          </label>
          <input
            type="text"
        ...
        <div className="col">
          <label htmlFor="filter_lrn" className="tt-label">
            LRN
          </label>
          <input
            type="text"
        ...
        <div className="col">
          <label htmlFor="filter_kennzeichen" className="tt-label">
            Kennzeichen
          </label>
          <input
            type="text"
        ...
        <div className="col">
          <label htmlFor="filter_transportunternehmen" className="tt-label">
        ...
        <div className="col position-relative">
          <label htmlFor="filter_ersteller" className="tt-label">
            Ersteller
          </label>
        ...
        <div className="col position-relative">
          <label htmlFor="filter_bearbeiter" className="tt-label">
            Bearbeiter
          </label>
          <div className="input-group input-group-sm">
            <input
        ...
        <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded">
          <div className="flex items-center justify-between">
            <div className="text-sm text-blue-800">
              <strong>Aktive Filter:</strong> {filteredClearances.length} von {clearances.length}{' '}
              Abfertigungen werden angezeigt
            </div>
          </div>
        </div>
      )}
      ...
      <div className="tt-scroll-y-container flex-1">
          ...
          <tbody>
            {currentClearances.map((clearance) => (
              <tr key={clearance.id}>
                ...
                <td className="text-center">
                  <span className="font-mono text-sm">{clearance.lrn}</span>
                </td>
        ...
        {currentClearances.length === 0 && (
          <div className="text-center py-12 text-gray-500">Keine Abfertigungen gefunden</div>
        )}
      </div>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            ...
            <p className="text-gray-600 mb-6">
              Möchten Sie die Abfertigung <strong>{formatAnmNr(clearanceToDelete.anmNr)}</strong>{' '}
              (LRN: {clearanceToDelete.lrn}) wirklich löschen?
            </p>
